<template>
	<fieldset>
		<section class="section">
			<h1>HTML LESSON 2 - The paragraph tag</h1>
			<div class="columns">
				<div class="column is-half">
					<div class="box has-background-royal-blue has-text-white-bis">
						<p>
                            Try wrapping the sentence on the right in a paragraph tag!<br>
                            When you have done it correctly, you'll see the color change!<br>
                            <span style="font-size:12px;font-weight:bold">*Hint: Do this in one line</span>
                        </p>
					</div>   
					<div>
						<img src="\images\girl-exercise.png">
					</div>    
				</div>
				<div class="column is-half">
