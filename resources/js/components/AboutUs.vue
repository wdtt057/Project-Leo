    ...
    <div class="box">
        ...
        <div class="team columns is-centered">
            <div class="column has-text-centered is-2">
                <img class="is-rounded" src="\images\josh_icon.png" width="150px" height="150px">
                <h2>Joshua Mejia</h2>
                <h3>Full Stack Developer</h3>
            </div> 
            <div class="column has-text-centered is-2">
                <img class="is-rounded" src="\images\elizabeth_icon.png" width="150px" height="150px">
                <h2>Elizabeth Barbieto</h2>
                <h3>UI Designer / Frontend Developer</h3>
            </div> 
            <div class="column has-text-centered is-2">
                <img class="is-rounded" src="\images\ryan_icon.png" width="150px" height="150px">
